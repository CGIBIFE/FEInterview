    ...
    render(){
        return (
            <div>
                ...
                <div className="tweet">
                    <span className="user-profile"><a href={`https://twitter.com/${this.props.user.screen_name}`} ><img className="profilePic" src={this.props.user.profile_image_url} />{this.props.user.name}</a></span>
